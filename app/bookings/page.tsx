...
export default async function BookingsPage() {
  ...
  return (
    <div className="min-h-dvh bg-[#0d1b2a] px-4 py-6 max-w-lg mx-auto">
          ...
          {bookings.map((booking: any) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h2 className="font-medium text-white text-base leading-snug">
              ...
              <div className="flex items-center gap-4 text-xs text-white/50 pt-3 border-t border-white/8">
                ...
                <div className="ml-auto font-medium text-white/70">
